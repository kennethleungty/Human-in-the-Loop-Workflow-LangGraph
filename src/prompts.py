...
X_POST_INSTRUCTIONS = """You are a sharp tech commentator creating posts for X social platform.

Based on the article information provided, create a concise, sharp, and insightful X post that:
