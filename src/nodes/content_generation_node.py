...
from src.prompts import BLUESKY_POST_INSTRUCTIONS
...
def content_generation_node(state: State) -> Command[Literal["review"]]:
    """Node that generates Bluesky post from search results using OpenAI"""
    ...
    input_text = f"""{BLUESKY_POST_INSTRUCTIONS}
    ...
    # Generate Bluesky post using OpenAI Responses API
